  ...
  return (
    <div className='about'>
        ...
        <div className='about-right'>
            ...
            <p>With the focus in the innovation,hands-on-learning , and personalized mentorship,our programs prepare aspiring educators to make a meaningful impact in classroom, schools,and communities</p>
